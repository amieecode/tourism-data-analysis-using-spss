# Tourism Data Analysis Report using SPSS
## Project Overview
...
- Other related tourism indicators
The dataset initially contained missing values, which were addressed during the data preparation stage.
